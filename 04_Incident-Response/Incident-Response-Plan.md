...
policy_id: FC-IRP-001
version: "1.0"
status: approved
approved_by: "Bruce Wayne"
...
This plan establishes a structured, repeatable process for responding to cybersecurity incidents at FinCorp. It ensures that incidents are handled in a way that minimizes damage, reduces recovery time, preserves evidence, and feeds lessons learned back into the ISMS.
...
- Ensure all personnel know how to report incidents (defined in Acceptable-use-policy Section 3.1)
...
|------|------|---------|----------------|
| CISO | Bruce Wayne | bwayne@fincorp.com / 617-555-0101 | All P1/P2; P3 by judgment |
| IT Director | James Okafor | jokafor@fincorp.com / 617-555-0102 | P1/P2/P3 |
| Legal Counsel | Rivera & Associates | legal@riveraassoc.com / 617-555-0190 | P1; any suspected breach |
| HR Director | Sandra Reeves | sreeves@fincorp.com / 617-555-0103 | Insider threat; employee involvement |
| CEO | Diana Prince | dprince@fincorp.com / 617-555-0100 | P1 only |
| Cyber Insurance | Coalition Insurance | Policy # CYB-2026-00441 / claims@coalitioninc.com | P1; any claim-worthy event |
