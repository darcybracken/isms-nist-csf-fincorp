...
> **Create this diagram in Lucidchart or Microsoft Visio.**
> Export as PNG and save to: `99_Attachments/Lab-002/ISMS_Architecture.png`
...
- [ ] Four zones with distinct color backgrounds
- [ ] Directional arrows showing data flow (labeled with data type: "PII", "Logs", "Backups")
- [ ] Firewall/boundary icons between zones
- [ ] NIST control labels in call-out boxes at each enforcement point
- [ ] Legend explaining colors, icons, and NIST reference format
- [ ] Title block: Wayne Financial Services — Data Flow Architecture with NIST CSF Control Overlay
...
- `99_Attachments/Lab-002/ISMS_Architecture.png` — Exported diagram